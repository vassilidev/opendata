    ...
    */
    public function addColumns(): ?PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('dateAjout_formatted', function (Client $model) {
                return Carbon::parse($model->dateAjout)->format('d/m/Y H:i:s');
            })
            ->addColumn('ancienClient')
    ...
    */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::add()
                ->title('DATEAJOUT')
                ->field('dateAjout_formatted', 'dateAjout')
                ->searchable()
                ->sortable()
                ->makeInputDatePicker('dateAjout'),
